...
const normalizeSolution = (raw: unknown): Solution => {
  ...
  return {
    ...
    seoTitle: value(item, 'seo_title', 'seoTitle'), seoDescription: value(item, 'seo_description', 'seoDescription'), imageMediaId: value(item, 'image_media_id') || null, imageUrl: value(item, 'image_url') || null, demoVideoMediaId: value(item, 'demo_video_media_id') || null, demoVideoUrl: assetUrl(value(item, 'demo_video_url')) || null, demoVideoType: (value(item, 'demo_video_type') as Solution['demoVideoType']) || null, status: contentStatus(item), featured: Boolean(value(item, 'featured') || false), sortOrder: Number(value(item, 'sort_order', 'sortOrder') || 0), createdAt: iso(item, 'created_at', 'createdAt'), updatedAt: iso(item, 'updated_at', 'updatedAt'),
  };
};
const normalizeProject = (raw: unknown): Project => {
  ...
  return {
    ...
    coverMediaId: value(item, 'cover_media_id') || null, demoVideoMediaId: value(item, 'demo_video_media_id') || null, demoVideoUrl: assetUrl(value(item, 'demo_video_url')) || null, demoVideoType: (value(item, 'demo_video_type') as Project['demoVideoType']) || null,
