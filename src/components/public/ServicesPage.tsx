            ...
            <div className="mt-8 flex flex-wrap gap-2">
              {[{ slug: 'ALL', name: 'All Services' }, ...serviceCategories].map(category => (
                <button
                  ...
                  className={`rounded-full px-4 py-2.5 min-h-10 text-xs font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0282EB] focus-visible:ring-offset-2 ${selectedCategory === category.slug ? 'bg-[#0282EB] text-white shadow-xs' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'}`}
                >
                  {category.name}
                </button>
              ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {filteredServices.map(service => (
            <Link
              ...
              className="bg-white rounded-3xl p-8 lg:p-10 border border-slate-200 hover:border-blue-300 hover:shadow-xl transition-all duration-200 flex flex-col justify-between group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0282EB] focus-visible:ring-offset-2"
            >
              <div>
              ...
              <span className="inline-flex items-center justify-between w-full bg-[#F8FAFC] group-hover:bg-blue-50 text-slate-800 group-hover:text-[#0282EB] font-semibold text-xs px-5 py-3.5 rounded-xl border border-slate-200 group-hover:border-blue-200 transition-all">
