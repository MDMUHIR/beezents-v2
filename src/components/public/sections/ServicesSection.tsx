        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((item, idx) => (
            <motion.div
              ...
              className="group relative bg-white p-6 sm:p-7 border border-slate-200 hover:border-[#0282EB] hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 flex flex-col justify-between cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0282EB] focus-visible:ring-offset-2"
            >
              <div>
                ...
                {/* Title */}
                <h3 className="text-lg font-bold text-[#111827] tracking-tight mb-2.5 uppercase group-hover:text-[#0282EB] transition-colors font-display">
                  {item.title}
                </h3>
